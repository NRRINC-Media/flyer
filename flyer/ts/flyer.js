...
;
function flyerrand() {
    var Flyerconf = ["FlyerconfA", "FlyerconfB", "FlyerconfC", "FlyerconfD", "FlyerconfE", "FlyerconfF", "FlyerconfG"];
    var random = Math.floor(Math.random() * Flyerconf.length);
    Flyerconf[random];
}
flyerrand();
function flyerinit() {
